...
public class TesteServiceGame {
    ...
    @Test
    public void testequantidadeGamesNitendoWii(){
        List<Game> ps4Games = ServiceGame.getListByPlatform(gameList, Platform.NitendoWii);

        Assert.assertEquals(5,ps4Games.size());
    }

    @Test
    public void testequantidadeGameX360(){
    ...
    @Test
    public void testequantidadeGameActivision(){
    ...
    @Test
    public void testequantidadeGameMicrosoft(){
